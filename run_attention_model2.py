...
if __name__ == '__main__':
    ...
    # feat6 = vgg16.get_layer('block5_pool').output
    # feat6 = Conv2D(512, (3, 3), padding='same', activation='relu')(feat6)

    # feature pyramid network
    # r1_v1 ~ v2
    # m6 = Conv2D(128, (1, 1), padding='same', activation='relu')(feat6)                              # stride: 32
    # m5 = Conv2D(128, (1, 1), padding='same', activation='relu')(feat5) + UpSampling2D((2, 2))(m6)   # stride: 16
    ...
    # r1_v1
    # p3 = AveragePooling2D((8, 8))(m3)
    # p3 = Conv2D(256, (3, 3), padding='same', activation='relu')(p3)
    # p4 = AveragePooling2D((4, 4))(m4)
    # p4 = Conv2D(256, (3, 3), padding='same', activation='relu')(p4)
    # p5 = AveragePooling2D((2, 2))(m5)
    # p5 = Conv2D(256, (3, 3), padding='same', activation='relu')(p5)

    # r1_v2
    # p3 = Conv2D(256, (3, 3), padding='same', activation='relu')(m3)
    # p3 = AveragePooling2D((8, 8))(p3)
    # p4 = Conv2D(256, (3, 3), padding='same', activation='relu')(m4)
    # p4 = AveragePooling2D((4, 4))(p4)
    # p5 = Conv2D(256, (3, 3), padding='same', activation='relu')(m5)
    # p5 = AveragePooling2D((2, 2))(p5)

    # featfin = concatenate([p3, p4, p5, m6], axis=-1)
